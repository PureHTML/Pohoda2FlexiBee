...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template name="faktura-vydana">
        <faktura-vydana>
            <xsl:if test="java:flexibee.Tool.trim(inv:invoiceHeader/inv:number/typ:numberRequested) != ''">
                ...
                <kod>
                    <xsl:value-of select="inv:invoiceHeader/inv:number/typ:numberRequested"/>
                </kod>
            </xsl:if>
            <varSym>
                <xsl:value-of select="inv:invoiceHeader/inv:symVar"/>
            </varSym>
            <cisObj>
                <xsl:value-of select="inv:invoiceHeader/inv:numberOrder"/>
            </cisObj>
            <xsl:choose>
            ...
            <datVyst>
                <xsl:value-of select="inv:invoiceHeader/inv:date"/>
            </datVyst>
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <duzpPuv>
                        <xsl:value-of select="inv:invoiceHeader/inv:dateTax"/>
                    </duzpPuv>
                    <duzpUcto>
                        <xsl:value-of select="inv:invoiceHeader/inv:dateTax"/>
                    </duzpUcto>
            ...
            <datSplat>
                <xsl:value-of select="inv:invoiceHeader/inv:dateDue"/>
            </datSplat>
            ...
            <xsl:choose>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:company != '' and inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:name != ''">
                    <nazFirmy>
                        <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:company"/> - <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:name"/>
                    </nazFirmy>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:company != ''">
                    <nazFirmy>
                        <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:company"/>
                    </nazFirmy>
                </xsl:when>
                <xsl:otherwise>
                    <nazFirmy>
                        <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:name"/>
                    </nazFirmy>
                </xsl:otherwise>
            </xsl:choose>
            <ulice>
                <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:street"/>
            </ulice>
            <mesto>
                <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:city"/>
            </mesto>
            <psc>
                <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:zip"/>
            </psc>
            <xsl:choose>
                <xsl:when test="not(inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids)">
                    <stat>
                        <xsl:value-of select="$defaultStat"/>
                    </stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = ''">
                    <stat>
                        <xsl:value-of select="$defaultStat"/>
                    </stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'CZE'">
                    <stat>code:CZ</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'SVK'">
                    <stat>code:SK</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'DEU'">
                    <stat>code:DE</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'FRA'">
                    <stat>code:FR</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'POL'">
                    <stat>code:PL</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'ITA'">
                    <stat>code:IT</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'AUT'">
                    <stat>code:AT</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'GBR'">
                    <stat>code:GB</stat>
                </xsl:when>
                <xsl:when test="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:country/typ:ids = 'ZAF'">
                    <stat>code:ZA</stat>
                </xsl:when>
                <xsl:otherwise>
            ...
            <ic>
                <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:ico"/>
            </ic>
            <dic>
                <xsl:value-of select="inv:invoiceHeader/inv:partnerIdentity/typ:address/typ:dic"/>
            </dic>
            ...
            <xsl:if test="inv:invoiceDetail">
                ...
                <polozkyDokladu removeAll="true">
                    <xsl:apply-templates select="inv:invoiceDetail/inv:invoiceItem">
                        <xsl:with-param name="invoiceType">
                            <xsl:value-of select="inv:invoiceHeader/inv:invoiceType"/>
                        </xsl:with-param> 
                    </xsl:apply-templates>
                </polozkyDokladu>
            </xsl:if>
            <xsl:if test="not(inv:invoiceDetail)">
                ...
                <sumOsv>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:priceNone"/>
                </sumOsv>
                <sumZklZakl>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:priceHigh"/>
                </sumZklZakl>
                <sumDphZakl>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:priceHighVAT"/>
                </sumDphZakl>
                <sumZklSniz>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:priceLow"/>
                </sumZklSniz>
                <sumDphSniz>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:priceLowVAT"/>
                </sumDphSniz>
                <sumZklSniz2>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:price3"/>
                </sumZklSniz2>
                <sumDphSniz2>
                    <xsl:value-of select="inv:invoiceSummary/inv:homeCurrency/typ:price3VAT"/>
                </sumDphSniz2>
            </xsl:if>

            <popis>
                <xsl:value-of select="inv:invoiceHeader/inv:text"/>
            </popis>
    ...
    <xsl:template match="inv:invoiceDetail/inv:invoiceItem">
        ...
        <faktura-vydana-polozka>
            ...
            <xsl:choose>
                <xsl:when test="inv:rateVAT = 'high'">
                    <typSzbDphK>typSzbDph.dphZakl</typSzbDphK>
                </xsl:when>
                <xsl:when test="inv:rateVAT = 'third'">
                    <typSzbDphK>typSzbDph.dphSniz2</typSzbDphK>
                </xsl:when>
                <xsl:when test="inv:rateVAT = 'low'">
                    <typSzbDphK>typSzbDph.dphSniz</typSzbDphK>
                </xsl:when>
                <xsl:when test="inv:rateVAT = 'none'">
                    <typSzbDphK>typSzbDph.dphOsv</typSzbDphK>
                </xsl:when>
                <xsl:when test="inv:rateVAT = '' or not(inv:rateVAT)">
                    <typSzbDphK>typSzbDph.dphOsv</typSzbDphK>
                </xsl:when>
                <xsl:otherwise>
            ...
            <xsl:choose>
                <xsl:when test="inv:payVAT = 'true'">
                    <typCenyDphK>typCeny.sDph</typCenyDphK>
                </xsl:when>
                <xsl:when test="inv:payVAT = 'false'">
